...
export type UserPartsFragment = { __typename?: 'User', id: number, name: string, avatar?: { __typename?: 'UserAvatar', large?: string | null } | null };
...
export const UserPartsFragmentDoc = gql`
  ...
  avatar {
    ...
    `;
export const MediaListCollectionPartsFragmentDoc = gql`
...
export const UserParts = gql`
  ...
  avatar {
    ...
    `;
export const MediaListCollectionParts = gql`
    fragment MediaListCollectionParts on MediaListCollection {
  lists {
    name
    status
